...
def plot_xmlrpc_times(insults_tasks, insults_times, filter_tasks, filter_times):
    output_dir = "XMLRPC/Plots"
    ...
    plt.title("Tiempo vs Cantidad de peticiones (XMLRPC)")
    plt.grid(True)
    plt.legend()
    plt.tight_layout()
...
if __name__ == "__main__":
    filename = "XMLRPC/test_results_s.txt"
    insults_tasks, insults_times, filter_tasks, filter_times = parse_xmlrpc_results(filename)
    plot_xmlrpc_times(insults_tasks, insults_times, filter_tasks, filter_times)
